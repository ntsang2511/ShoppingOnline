    ...
    <Loading isLoading={isPending}>
      <div style={{ width: '100%', height: '100vh', background: '#f5f5fa' }}>
        <div style={{ width: '1270px', margin: '0 auto', height: '1270px' }}>
          <div style={{ color: 'red', fontSize: '2rem', fontWeight: 'bold', marginTop: '10px' }}>Chi tiết đơn hàng</div>
          <WrapperHeaderUser>
            <WrapperInfoUser>
              ...
              <WrapperContentInfo>
                ...
                <div className="address-info">
                  <span style={{ fontSize: '1.5rem' }}>Địa chỉ: </span>
                  <span>{`${data?.shippingAddress?.address} ${data?.shippingAddress?.city}`}</span>
                </div>
