...
export const StyledIconContainer = styled.div`
  width: 40px;
  height: 40px;
  background-color: ${props => props.isPrimary ? 'rgba(251, 193, 7, 0.1)' : 'rgba(44, 124, 241, 0.1)'};
  border-radius: 50%;
  display: flex;
  align-items: center;
  ...
  &:hover {
    background-color: ${props => props.isPrimary ? 'rgba(251, 193, 7, 0.2)' : 'rgba(44, 124, 241, 0.2)'};
  }
`;
